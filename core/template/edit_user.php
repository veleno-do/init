    ...
    <div class="container">
        <div class="body">
            <div class="yui-el__bar1">
                ...
                <h1 class="yui-el__bar1-title">Settings</h1>
            ...
            <div class="l-main">
                <div class="main__breadcrumb">
                    <span class="main__breadcrumb-head">Settings</span>
                </div>
                <section class="main__tasks">
                    <div class="main__tasks-wrap">
                        ...
                        <a class="main__tasks-cont" href="javascript:void(0)" target="_self">
                            <h3 class="main__tasks-cont-name">User name</h3>
                            <p class="main__tasks-cont-status">user name</p>
                        </a>
                        <a class="main__tasks-cont" href="javascript:void(0)" target="_self">
                            <h3 class="main__tasks-cont-name">User address</h3>
